...
// edge, cut radius 36 (a tight 4px ring). Single SVG arc command, not an
// approximated curve.
const NOTCH_PATH =
  "M0,56 C0,44.954 8.954,36 20,36 H144 A36,36 0 0 1 216,36 H340 C351.046,36 360,44.954 360,56 V100 H0 V56 Z";
