...
import { PartnerManagementClient } from "@/components/ops/PartnerManagementClient";
import { Card } from "@/components/shared/Card";
import { Button } from "@/components/shared/Button";
import { opsSignOutAction } from "@/lib/ops-auth-actions";

// OP-009 Partner Management's entry point. Same three-state operator gate
...
export default async function PartnersPage() {
  ...
  return <PartnerManagementClient data={data} />;
}
