...
import { AllocationEngineClient } from "@/components/ops/AllocationEngineClient";
import { Card } from "@/components/shared/Card";
import { Button } from "@/components/shared/Button";
import { opsSignOutAction } from "@/lib/ops-auth-actions";

// OP-004 Allocation Engine's entry point. Same three-state operator gate
// as /ops, /ops/opportunities and /ops/opportunities/[id] (see those
// pages' own comments).
export default async function AllocationsPage() {
  ...
  return <AllocationEngineClient data={data} />;
}
