...
import { ContributorManagementClient } from "@/components/ops/ContributorManagementClient";
import { Card } from "@/components/shared/Card";
import { Button } from "@/components/shared/Button";
import { opsSignOutAction } from "@/lib/ops-auth-actions";

// OP-008 Contributor Management's entry point. Same three-state operator
...
export default async function ContributorsPage() {
  ...
  return <ContributorManagementClient data={data} />;
}
