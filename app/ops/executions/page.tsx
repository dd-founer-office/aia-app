...
import { getExecutionManagementData } from "@/lib/execution";
import { ExecutionManagementClient } from "@/components/ops/ExecutionManagementClient";
import { Card } from "@/components/shared/Card";
import { Button } from "@/components/shared/Button";
import { opsSignOutAction } from "@/lib/ops-auth-actions";

// OP-005 Execution Management's entry point. Same three-state operator
...
export default async function ExecutionsPage() {
  ...
  return <ExecutionManagementClient data={data} />;
}
