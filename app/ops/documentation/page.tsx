...
import { getDocumentationCenterData } from "@/lib/documentation";
import { DocumentationCenterClient } from "@/components/ops/DocumentationCenterClient";
import { Card } from "@/components/shared/Card";
import { Button } from "@/components/shared/Button";
import { opsSignOutAction } from "@/lib/ops-auth-actions";

// OP-006 Documentation Center's entry point. Same three-state operator
// gate as the other Ops pages (see their own comments).
export default async function DocumentationPage() {
  ...
  return <DocumentationCenterClient data={data} />;
}
