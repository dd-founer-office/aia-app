...
export const LIVING_FIELD_CONFIG: LivingFieldConfig = {
  ...
  // LOCKED — Living Field Foundation Completion v1.0. Founder-selected
  // final calibration: Candidate B (2.5), chosen after live review of
  // three candidates (A=2.8, B=2.5, C=2.2) via the now-removed
  // NEXT_PUBLIC_INTENSITY_CANDIDATE mechanism. This value's history: began
  // at 1.0 (Sprint 01 shipped calibration), was temporarily raised to 3.5
  // for development visibility, then this final round of founder review
  // settled on 2.5 as the resting value. No further runtime configuration
  // remains -- change this literal directly for any future recalibration.
  intensity: 2.5,
